  ...
  return (
    <Box sx={{ width: 312, height: 145*2}}>
      <Link to={`/channel/${channelId}`}>
        ...
        <Card sx={{background: "#252525", ":hover": {background: "#333"}, borderRadius: 3, height: 145, translate:"0 -20%", display: "flex", justifyContent: "center", alignItems: "center"}}>
